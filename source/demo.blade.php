...
@section('body')
  <section class="bg-white/90 custom-border px-6 py-20">
    <div class="space-y-4 sm:space-y-6 sm:max-w-4xl mx-auto w-full text-center">
      ...
      <p>There's a demo app available so you can see what a Hotwired Laravel app might feel like. Of course, this is just a simple demo, Hotwired apps might feel very different from one another, it all depends on how much progressive enhancements you have added to your app.</p>
